...
const TechForm: React.FC<TechFormProps> = ({ initialData, onSave, onCancel, onDelete }) => {
    ...
    return (
        <div className="tech-form-container" onClick={(e) => e.stopPropagation()}>
            <button className="tech-form-close" onClick={onCancel} title="Cerrar">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="tech-form-actions">
                    <button type="submit" className="tech-action-btn btn-save">
                        {initialData ? 'GUARDAR CAMBIOS' : 'CREAR TECNOLOGIA'}
                    </button>
                    {initialData && (
                        <button type="button" className="tech-action-btn tech-delete-main-btn" onClick={onDelete}>
                            ELIMINAR
                        </button>
                    )}
                    <button type="button" className="tech-action-btn btn-cancel" onClick={onCancel}>
                        CANCELAR
                    </button>
                </div>
            </form>
